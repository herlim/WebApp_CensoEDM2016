        ...
        <div id="table" class="table-editable">            
            <table class="table">
                ...
                <tr>
                    ...
                    <td contenteditable="true">{!! Form::select('sdepartamento', [ 'S', 'L','XL'], null, ['class' => 'form-control ', 'id' => 'scertificado']) !!}</td>
                    <td contenteditable="true">{!! Form::select('sCargo', [ 'S', 'L','XL'], null, ['class' => 'form-control ', 'id' => 'sintituicao']) !!}</td>
                    <td contenteditable="true">{!! Form::select('sprof', [ 'S', 'L','XL'], null, ['class' => 'form-control ', 'id' => 'scertificado']) !!}</td>
                </tr>
                <tr>
                    <td contenteditable="true"></td>                
                    <td contenteditable="true">{!! Form::date('name', \Carbon\Carbon::now()) !!}</td>
